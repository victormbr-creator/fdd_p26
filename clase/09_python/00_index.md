...
:::homework{id="9.0" title="Instalar Python, uv, pip y pyenv" due="2026-02-17" points="0"}
...
:::homework{id="9.1" title="Curso de Python Introductorio" due="2026-02-17" points="20"}
...
:::homework{id="9.2" title="Hello World en Python" due="2026-02-17" points="0"}

Verifica que tu instalación de Python funciona correctamente de dos formas:
No olvideas hacerlo en tu carpeta, puedes llamarla python para tener todo ordenado.
...
2. **Script**: crea un archivo `hello.py` y ejecútalo:
...
:::homework{id="9.3" title="Curso de Python Intermedio" due="2026-02-19" points="20"}
...
:::homework{id="9.4" title="Curso de Software Engineering Principles in Python" due="2026-02-24" points="20"}
...
:::homework{id="9.5" title="Curso de Pandas" due="2026-02-26" points="20"}
...
:::homework{id="9.7" title="Introduccion a FastAPI" due="2026-03-05" points="20"}

Curso de Python:https://app.datacamp.com/learn/courses/introduction-to-fastapi

Completa el curso y sube la certificacion a tu directorio de certificaciones, crea un nuevo file llamado python_fast_api_06.md y adjunta el link a la certificacion. No olvides referenciarlo en canvas (el pull request).
